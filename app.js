...
myApp.config(function ($routeProvider) {
    $routeProvider
	.when("/tenants",  { controller: "tenantsController", templateUrl: "tenants.html" })
	.when("/users/:id",  { controller: "usersController", templateUrl: "users.html" })
    	.when("/users",  { controller: "usersController", templateUrl: "users.html" })
	.when("/user/:pName/:dName/:id",  { controller: "userController", templateUrl: "user.html" })
	.when("/licenses/:id",  { controller: "licensesController", templateUrl: "licenses.html" })
